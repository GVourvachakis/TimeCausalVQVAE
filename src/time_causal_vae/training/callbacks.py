...
from time_causal_vae.utils.plotting import visualize_data, visualize_real_recon_fake
    ...
    def setup(
        ...
        **kwargs,
        ...
        args:
            ...
            model_config (BaseConfig): The model configuration used in the run.

            project_name (str): The name of the wandb project to use.

            entity_name (str): The name of the wandb entity to use.

            run_name (str): Optional display name for this W&B run.

            wandb_mode (str): Optional W&B mode, such as online, offline, or disabled.
        """
        ...
        init_kwargs = {
            ...
            "entity": entity_name,
            "dir": training_config.wandb_output_dir,
        }

...
import numpy as np
import tqdm
from time_causal_vae.evaluation.external.optimal_stopping.algorithms.finite_difference import finite_difference_pricer
    ...
    def price(self, stock_paths=None, verbose=1, **kwargs):
        ...
        for n in tqdm.tqdm(reversed(steps[:-1]), disable=(not verbose)):
            ...
            option_prices = discount_factor * (
                proba_up * option_prices[: n + 1] + proba_down * option_prices[1 : n + 2]
            )

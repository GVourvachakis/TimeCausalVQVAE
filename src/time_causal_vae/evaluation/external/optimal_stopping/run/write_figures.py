...
from time_causal_vae.evaluation.external.optimal_stopping.utilities import comparison_table, configs_getter, plot_convergence_study, plot_hurst
    ...
    for config_name, config in configs_getter.get_configs():
        ...
        for representation in representations:
            ...
            if representation not in methods:
                raise AssertionError(f"Unknown representation type {config.representation}")
            try:

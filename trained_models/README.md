...
Expected checkpoints and generated samples live under local, ignored `outputs/`
paths after a user runs the training or evaluation commands. Do not commit model
